...
Route::group(['middleware' => ['role:super_admin']], function () { 
    ...
    Route::get('trans-exports', [App\Http\Controllers\TransactionController::class, "export"])->name("trans-exports");
...
Route::get('exports', [App\Http\Controllers\Admin\buyerseller\ProductController::class, "export"])->name("exports");
...
// Route::get('/payout',[App\Http\Controllers\PayoutController::class,'payamount'])->name('payout');  
Route::get('/transaction-tracker',[App\Http\Controllers\PayoutController::class,'TransactionTracker'])->name('transaction-tracker');
Route::get('pay-exports', [App\Http\Controllers\PayoutController::class, "export"])->name("pay-exports");
